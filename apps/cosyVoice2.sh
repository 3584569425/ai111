...
gf_url="https://gf.bilibili.com/item/detail/1107198073"

# 脚本信息
echo "================================================"
echo "描述: cosyVoice2 主程序，用于管理 cosyVoice2 的安装和配置"
echo "作者: ai来事"
echo "创建日期: 2024-12-24"
...
# 创建必要的目录
echo "创建必要的目录..."
mkdir -p ai4u/apps/cosyVoice2/scripts

# 复制脚本文件
if [ -d "scripts" ]; then
    echo "复制安装脚本..."
    cp -r scripts/* ai4u/apps/cosyVoice2/scripts/
else
...
# 检查必要文件是否存在
if [ ! -f "ai4u/apps/cosyVoice2/scripts/install.sh" ]; then
